...
#import "TokenFieldCell.h"

@implementation TokenFieldCell
...
- (NSText *)setUpFieldEditorAttributes:(NSText *)textObj
{
    ...
    if([textView isKindOfClass:[NSTextView class]])
    {
        ...
        [mutableParagraphStyle setLineSpacing:20];
        [mutableParagraphStyle setFirstLineHeadIndent:30];
        [mutableParagraphStyle setLineHeightMultiple:50];
        [textView setDefaultParagraphStyle:mutableParagraphStyle];
    }
    return textView;
}
