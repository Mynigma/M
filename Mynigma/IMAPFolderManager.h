...
@class MCOIMAPSession, IMAPAccountSetting, IMAPFolderSetting, EmailMessage, IMAPAccount, EmailMessageInstance, DisconnectOperation;


@interface IMAPFolderManager : NSObject
