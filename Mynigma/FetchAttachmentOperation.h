...
@interface FetchAttachmentOperation : SerialisableOperation
...
@property MCOEncoding encoding;
@property BOOL urgent;

@property(strong) MCOIMAPBaseOperationProgressBlock progressCallback;

@property(strong) void(^callback)(NSError* error, NSData* partData);
