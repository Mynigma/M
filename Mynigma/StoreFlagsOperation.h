...
@class IMAPSessionHelper;

@interface StoreFlagsOperation : SerialisableOperation
...
@property MCOIMAPStoreFlagsRequestKind requestKind;
@property MCOMessageFlag flags;
