...
@class Contact, EmailContactDetail, MynigmaPublicKey, EmailRecipient;
...
@property EmailContactDetail* contactDetail;
@property NSInteger type;

- (id)initWithEmail:(NSString*)email andName:(NSString*)name;
//- (id)initWithEmail:(NSString*)email andName:(NSString*)name inContext:(NSManagedObjectContext*)localContext;
