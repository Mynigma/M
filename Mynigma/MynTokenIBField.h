...
@class MynTokenFieldController;

@interface MynTokenIBField : UIView

@property IBOutlet id tokenFieldDelegate;

@property MynTokenFieldController* tokenFieldController;

@property BOOL shouldHide;

@property NSNumber* rightMargin;
