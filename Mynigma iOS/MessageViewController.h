...
@interface MessageViewController : UITableViewController <UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate>
{
...
@property NSArray* fromRecipients;

@property NSArray* replyToRecipients;
