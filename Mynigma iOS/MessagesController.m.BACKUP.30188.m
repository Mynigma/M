...
=======
#import "EmailMessage+Category.h"
>>>>>>> 77589748cdbea3ed94e1da09716139f6afc6043a
...
{
    NSSet* folders = [OutlineObject selectedFolderSettingsForSyncing];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    NSLog(@"%ld rows in table view", (long)numRows);
...
- (void)refreshLoadMoreCell
{
    ...
    NSInteger indexOfLastRow = [APPDELEGATE.messagesController.tableView numberOfRowsInSection:0]-1;
